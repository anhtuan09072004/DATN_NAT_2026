...
@RestController
@RequestMapping(value = "/api/co-ao", produces = "application/json")
@RequiredArgsConstructor
public class CoAoController {
    private final CoAoService service;

    @PostMapping
    public ResponseEntity<?> create(@Valid @RequestBody CoAoRequest request) {
    ...
    public ResponseEntity<?> update(
            ...
            @Valid @RequestBody CoAoRequest request) {
