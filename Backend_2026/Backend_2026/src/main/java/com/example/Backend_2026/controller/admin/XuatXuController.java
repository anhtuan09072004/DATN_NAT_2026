...
@RestController
@RequestMapping(value = "/api/xuat-xu", produces = "application/json")
@RequiredArgsConstructor
public class XuatXuController {
    private final XuatXuService service;

    @PostMapping
    public ResponseEntity<?> create(@Valid @RequestBody XuatXuRequest request) {
    ...
    public ResponseEntity<?> update(
            ...
            @Valid @RequestBody XuatXuRequest request) {
