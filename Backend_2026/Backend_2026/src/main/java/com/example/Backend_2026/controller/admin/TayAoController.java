...
@RestController
@RequestMapping(value = "/api/tay-ao", produces = "application/json")
@RequiredArgsConstructor
public class TayAoController {
    private final TayAoService service;

    @PostMapping
    public ResponseEntity<?> create(@Valid @RequestBody TayAoRequest request) {
    ...
    public ResponseEntity<?> update(
            ...
            @Valid @RequestBody TayAoRequest request) {
